...
annotate adminDashboardSrv.Quizzes with {
  ID @Common.Text: { $value: quizId, ![@UI.TextArrangement]: #TextOnly };
};
...
annotate adminDashboardSrv.Quizzes with @UI.LineItem #quizzesTable: [
    { $Type: 'UI.DataField', Value: quizId },
...
annotate adminDashboardSrv.Quizzes with @UI.LineItem #questionsTable: [
    { $Type: 'UI.DataField', Value: questions.questionId },
    { $Type: 'UI.DataField', Value: questions.text },
    { $Type: 'UI.DataField', Value: questions.quizzes.title }
];
...
annotate adminDashboardSrv.Questions with @UI.LineItem #questionsSection: [
    { $Type: 'UI.DataField', Value: questionId },
...
annotate adminDashboardSrv.Quizzes with @UI.Facets: [
  {
    ...
    Facets: [
      { $Type: 'UI.ReferenceFacet', ID: 'quizDetails', Label: 'Quiz Details', Target: '@UI.FieldGroup#quizDetails' },
      { $Type: 'UI.ReferenceFacet', ID: 'questionsSection', Label: 'Questions', Target: 'questions/@UI.LineItem#questionsSection' } ]
  }
];
...
annotate adminDashboardSrv.Questions with @UI.HeaderFacets: [
 { $Type : 'UI.ReferenceFacet', Target : '@UI.DataPoint#text', ID: 'Text' }
];
...
annotate adminDashboardSrv.Questions with {
  ID @Common.Text: { $value: questionId, ![@UI.TextArrangement]: #TextOnly };
  quizzes @Common.Text: { $value: quizzes.quizId, ![@UI.TextArrangement]: #TextOnly };
};
annotate adminDashboardSrv.Questions with @UI.SelectionFields: [
  quizzes_ID
];
annotate adminDashboardSrv.Questions with @UI.LineItem: [
    ...
    { $Type: 'UI.DataField', Value: questionId },
    { $Type: 'UI.DataField', Value: text },
    { $Type: 'UI.DataField', Label: 'Quiz', Value: quizzes_ID }
];
annotate adminDashboardSrv.Answers with @UI.LineItem #questionsSection1: [
    { $Type: 'UI.DataField', Value: answerId },
    { $Type: 'UI.DataField', Value: text },
    { $Type: 'UI.DataField', Value: isCorrect_code, Criticality: isCorrect.criticality }
...
annotate adminDashboardSrv.Questions with @UI.Facets: [
  {
    ...
    Facets: [
      { $Type: 'UI.ReferenceFacet', ID: 'questionsSection1', Label: 'Questions', Target: 'answers/@UI.LineItem#questionsSection1' },
      { $Type: 'UI.ReferenceFacet', ID: 'answersSection', Label: 'Answers', Target: 'answers/@UI.LineItem#answersSection' } ]
  }
];
...
annotate adminDashboardSrv.Answers with @UI.HeaderFacets: [
 { $Type : 'UI.ReferenceFacet', Target : '@UI.DataPoint#text', ID: 'Text' },
 { $Type : 'UI.ReferenceFacet', Target : '@UI.DataPoint#isCorrect', ID: 'IsCorrect' }
];
...
annotate adminDashboardSrv.Answers with {
  ID @Common.Text: { $value: answerId, ![@UI.TextArrangement]: #TextOnly };
  questions @Common.Text: { $value: questions.questionId, ![@UI.TextArrangement]: #TextOnly };
  isCorrect @Common.Text : { $value: isCorrect.name, ![@UI.TextArrangement]: #TextOnly };
};
annotate adminDashboardSrv.Answers with {
...
annotate adminDashboardSrv.Users with @UI.SelectionFields: [
  userId
];
...
annotate adminDashboardSrv.Results with @UI.HeaderFacets: [
 { $Type : 'UI.ReferenceFacet', Target : '@UI.DataPoint#score', ID: 'Score' }
];
...
annotate adminDashboardSrv.Results with {
  ID @Common.Text: { $value: resultId, ![@UI.TextArrangement]: #TextOnly };
  users @Common.Text: { $value: users.userId, ![@UI.TextArrangement]: #TextOnly };
};
annotate adminDashboardSrv.Results with @UI.SelectionFields: [
  users_ID
];
annotate adminDashboardSrv.Results with @UI.LineItem #resultsTable: [
    { $Type: 'UI.DataField', Value: resultId },
    { $Type: 'UI.DataField', Value: score },
    { $Type: 'UI.DataField', Value: users.username }
];
...
annotate adminDashboardSrv.Results with @UI.FieldGroup #Main: {
  $Type: 'UI.FieldGroupType', Data: [
    ...
    { $Type: 'UI.DataField', Value: resultId },
    { $Type: 'UI.DataField', Value: score },
    { $Type: 'UI.DataField', Label: 'User', Value: users_ID }
]};
